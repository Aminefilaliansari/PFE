...
(SELECT CONCAT(' ADMIN ',zone.commune) as ann,SUM(financeprojet.Contrib_Etat) FROM `financeprojet`INNER JOIN zone ON financeprojet.idprojet = zone.idprojet
...
<div class="row">
<form>
<label style="margin-top: 30px;margin-left:217px;">Commune : </label style="">
<div  style="margin-left:217px;width: 350px;">

<select class="form-control" name="commune22" id="commune22" placeholder="">
<option></option>

 <?php  
           
               $sql = "SELECT DISTINCT(commune) FROM `zone`";
...
<div id="req_fin_22_pie" style="margin-top: 0px;"></div>
</form>
</div>
