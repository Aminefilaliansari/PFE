...
if (isset($_POST['ajax']) && isset($_POST['provaince88'])) {


if($_POST['provaince88']==""){
...
(SELECT zone.Typecommune, SUM(financeprojet.Contrib_Etat+financeprojet.Contrib_Etabli) FROM `zone` INNER JOIN financeprojet ON zone.idprojet = financeprojet.idprojet
WHERE Typecommune='Rural' AND zone.provaince='".$_POST['provaince88']."'
 GROUP BY zone.Typecommune
)
UNION

(SELECT zone.Typecommune, SUM(financeprojet.Contrib_Etat+financeprojet.Contrib_Etabli) FROM `zone` INNER JOIN financeprojet ON zone.idprojet = financeprojet.idprojet
WHERE Typecommune='Urbain' AND zone.provaince='".$_POST['provaince88']."'
 GROUP BY zone.Typecommune
)
